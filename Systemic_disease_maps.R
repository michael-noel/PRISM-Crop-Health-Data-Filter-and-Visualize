...
map + geom_point(data = bbn.summary, aes(x = lon, y = lat, size = rating, colour = rating)) + 
  ...
  coord_map() +
  facet_grid(. ~ visit)
ggsave("Injury_Graphs/Bug_burn_map.png", width = 8, height = 8, units = "in")
...
map + geom_point(data = hbn.summary, aes(x = lon, y = lat, size = rating, colour = rating)) + 
  ...
  coord_map() +
  facet_grid(. ~ visit)
ggsave("Injury_Graphs/Hopper_burn_map.png", width = 8, height = 8, units = "in")
...
map + geom_point(data = tun.summary, aes(x = lon, y = lat, size = rating, colour = rating)) + 
  ...
  coord_map() +
  facet_grid(. ~ visit)
ggsave("Injury_Graphs/Tungro_map.png", width = 8, height = 8, units = "in")
...
map + geom_point(data = grs.summary, aes(x = lon, y = lat, size = rating, colour = rating)) + 
  ...
  coord_map() +
  facet_grid(. ~ visit)
ggsave("Injury_Graphs/Grassy_stunt_map.png", width = 8, height = 8, units = "in")
...
map + geom_point(data = rgd.summary, aes(x = lon, y = lat, size = rating, colour = rating)) + 
  ...
  coord_map() +
  facet_grid(. ~ visit)
ggsave("Injury_Graphs/Ragged_stunt_map.png", width = 8, height = 8, units = "in")
...
map + geom_point(data = olf.summary, aes(x = lon, y = lat, size = rating, colour = rating)) + 
  ...
  coord_map() +
  facet_grid(. ~ visit)
ggsave("Injury_Graphs/Orange_leaf_map.png", width = 8, height = 8, units = "in")
...
map + geom_point(data = ylo.summary, aes(x = lon, y = lat, size = rating, colour = rating)) + 
  ...
  coord_map() +
  facet_grid(. ~ visit)
ggsave("Injury_Graphs/Yellow_dwarf_map.png", width = 8, height = 8, units = "in")
